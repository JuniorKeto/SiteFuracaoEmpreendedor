...
<div class="hero-wrap" style="background-image: url(<?= url(IMG . "bg_1.jpg") ?>);" data-stellar-background-ratio="0.5">
	...
	<div class="row">
		<div class="col-md-3 d-flex align-items-stretch">
			<div class="case-wrap d-flex">
				<div class="img" style="background-image: url(<?= url(IMG . "case-1.jpg") ?>);">
					<div class="text">
						<h2>Business Law</h2>
		...
		<div class="col-md-6 d-flex align-items-stretch">
			<div class="case-wrap d-flex">
				<div class="img" style="background-image: url(<?= url(IMG . "case-2.jpg") ?>);">
					<div class="text">
		...
		<div class="col-md-3 d-flex align-items-stretch">
			<div class="case-wrap d-flex">
				<div class="img" style="background-image: url(<?= url(IMG . "case-3.jpg") ?>);">
					<div class="text">
		...
		<div class="col-md-3 d-flex align-items-stretch">
			<div class="case-wrap d-flex">
				<div class="img" style="background-image: url(<?= url(IMG . "case-4.jpg") ?>);">
					<div class="text">
						<h2>Business Law</h2>
						<p>Far far away, behind the word</p>
					</div>
		...
		<div class="col-md-3 d-flex align-items-stretch">
			<div class="case-wrap d-flex">
				<div class="img" style="background-image: url(<?= url(IMG . "case-5.jpg") ?>);">
					<div class="text">
						<h2>Business Law</h2>
						<p>Far far away, behind the word</p>
					</div>
		...
		<div class="col-md-3 d-flex align-items-stretch">
			<div class="case-wrap d-flex">
				<div class="img" style="background-image: url(<?= url(IMG . "case-6.jpg") ?>);">
					<div class="text">
						<h2>Business Law</h2>
						<p>Far far away, behind the word</p>
					</div>
		...
		<div class="col-md-3 d-flex align-items-stretch">
			<div class="case-wrap d-flex">
				<div class="img" style="background-image: url(<?= url(IMG . "case-7.jpg") ?>);">
					<div class="text">
						<h2>Business Law</h2>
						<p>Far far away, behind the word</p>
					</div>
...
<section class="ftco-section testimony-section">
		...
		<div class="carousel-testimony owl-carousel ftco-owl">
			...
			<div class="testimony-wrap py-4">
				...
				<div class="d-flex align-items-center">
					<div class="user-img" style="background-image: url(<?= url(IMG . "person_1.jpg") ?>)"></div>
					<div class="pl-3">
			...
			<div class="testimony-wrap py-4">
				...
				<p class="mb-4">Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts.</p>
				<div class="d-flex align-items-center">
					<div class="user-img" style="background-image: url(<?= url(IMG . "person_2.jpg") ?>)"></div>
					<div class="pl-3">
						<p class="name">Roger Scott</p>
						<span class="position">Marketing Manager</span>
						</div>
			...
			<div class="testimony-wrap py-4">
				...
				<p class="mb-4">Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts.</p>
				<div class="d-flex align-items-center">
					<div class="user-img" style="background-image: url(<?= url(IMG . "person_3.jpg") ?>)"></div>
					<div class="pl-3">
						<p class="name">Roger Scott</p>
						<span class="position">Marketing Manager</span>
						</div>
	...
	<section class="ftco-appointment ftco-section img" style="background-image: url(<?= url(IMG . "bg_2.jpg") ?>);">
		<div class="overlay"></div>
	<div class="container">
		<div class="row">
...
<section class="ftco-section">
	...
	<div class="row d-flex">
		...
		<div class="blog-entry justify-content-end">
			...
			<a href="blog-single.html" class="block-20 img d-flex align-items-center" style="background-image: url(<?= url(IMG . "image_1.jpg") ?>);">
		...
		<div class="blog-entry justify-content-end">
			<div class="text text-center">
			<a href="blog-single.html" class="block-20 img d-flex align-items-center" style="background-image: url(<?= url(IMG . "image_2.jpg") ?>);">
				<div class="meta text-center mb-2 d-flex align-items-center justify-content-center">
					<div>
						<span class="day">02</span>
						<span class="mos">June</span>
		...
		<div class="blog-entry justify-content-end">
			<div class="text text-center">
			<a href="blog-single.html" class="block-20 img d-flex align-items-center" style="background-image: url(<?= url(IMG . "image_3.jpg") ?>);">
				<div class="meta text-center mb-2 d-flex align-items-center justify-content-center">
					<div>
						<span class="day">02</span>
						<span class="mos">June</span>
